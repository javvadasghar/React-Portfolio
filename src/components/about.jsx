                ...
                >
                  <div className="col-md-12">
                    <div className="about-desc">
                      ...
                      <p>
                        I am a computer grad student from Comsats University
                        Islamabad with Software Engineering as my major.I love
              ...
              <div className="col-md-4 text-center animate-box">
                <div className="services color-3">
                  ...
                  <div className="desc">
                    ...
                    <p>I made a lot of Android Apps through out my degree.</p>
                  </div>
                </div>
              </div>
              <div className="col-md-4 text-center animate-box">
                <div className="services color-5">
                  ...
                  <div className="desc">
                    <h3>Data Science</h3>
                    <p>
                      I am taking course of Data Science from Udemy as I have
                      strong concepts of Python, Maths and Probability.
                    </p>
                  </div>
                </div>
              </div>
